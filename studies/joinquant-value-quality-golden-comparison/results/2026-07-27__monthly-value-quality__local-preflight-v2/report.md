...
- 本地累计收益 60.69%，年化 11.59%，
  ...
  换手 35.61，平均现金 0.61%。
- 拒单 25 次；点时和数据质量检查：{'all_rebalances_have_20_targets': True, 'future_notice_rows_zero': True, 'fundamental_partition_failures_zero': True, 'industry_partition_failures_zero': True, 'future_industry_intervals_zero': True, 'selected_execution_state_quality_at_least_b': True, 'filled_trade_state_quality_at_least_b': True, 'trades_present': True}。
