...
- 共 54 次调仓；每次最少 3327 只合格候选；
  每次均选 10 只。
- 本地累计收益 31.61%，年化 6.56%，
  最大回撤 41.61%，Sharpe 0.364，
  换手 30.52，平均现金比例 0.19%。
- 拒单 95 次；点时、覆盖和归档检查：{'full_master_is_6115': True, 'all_rebalances_have_ten_targets': True, 'no_valuation_future_data': True, 'no_partition_read_failures': True, 'no_future_name_events': True, 'no_future_delisting_events': True, 'known_st_for_archived_candidates': True, 'all_filled_orders_use_a_or_b_state': True, 'nonnegative_cash': True, 'orders_and_ledgers_present': True, 'delisting_actions_audited': True}。
