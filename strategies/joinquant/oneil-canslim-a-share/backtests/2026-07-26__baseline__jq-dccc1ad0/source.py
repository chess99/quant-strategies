...
def refresh_watchlist(context):
    ...
    try:
        ...
        _log(
            ...
            "fundamental=%d eligible=%d veto_hits=%s eligible_codes=%s",
            observation_date,
            len(universe),
            len(relative),
...
def daily_trade(context):
    ...
    try:
        ...
        market_allows_entries = market["state"] == MARKET_CONFIRMED
        ...
        if not market_allows_entries:
            _log(
                ...
                "correction_reason=%s transition_distributions=%d",
                observation_date,
                market["state"],
