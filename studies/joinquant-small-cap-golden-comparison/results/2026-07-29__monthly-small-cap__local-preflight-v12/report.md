...
- 共 54 次调仓；每次最少 3349 只合格候选；
  每次均选 10 只。
- 本地累计收益 66.51%，年化 12.51%，
  最大回撤 47.56%，Sharpe 0.553，
  换手 28.47，平均现金比例 0.01%。
- 拒单 83 次；点时、覆盖和归档检查：{'full_master_is_6115': True, 'all_rebalances_have_ten_targets': True, 'no_valuation_future_data': True, 'no_partition_read_failures': True, 'no_future_name_events': True, 'no_future_delisting_events': True, 'known_st_for_archived_candidates': True, 'all_filled_orders_use_a_or_b_state': True, 'nonnegative_cash': True, 'orders_and_ledgers_present': True, 'delisting_actions_audited': True}。
